...
const Price: FC<PriceProps> = ({ error }) => {
  return (
    <div className="sm:grid sm:gap-4 mb-6 sm:grid-cols-[212px_1fr] sm:grid-rows-[56px_auto]">
      <h3 className="text-sm max-sm:mb-4 pt-[18px]">Цена</h3>
      <Input style={{ outline: error ? "2px solid red" : "" }} placeholder="₽" name="price" className="w-full lg:w-[480px] mb-4 max-sm:mb-2" />
